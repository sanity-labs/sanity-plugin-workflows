...
- 947e58b: Document that the comments/tasks addon dataset must be initialised from Studio (add a comment or create a task once) before stage tasks / completion gating can work, and add troubleshooting for the missing-dataset console warning.
